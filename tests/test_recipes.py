...
class TestCasesRecipes(unittest.TestCase):
    ...
    def test_edit_existing_recipe(self):
        ...
        msg = self.recipes.create_recipe(
            'Pilau Njeri', 'Rave', "eunicegatehi@gmail.com")
        self.assertIn("name already exists", msg)

    def test_delete_shoppinglist(self):
        """Check to see if shoppinglist is deleted
        """
        self.recipes.create_recipe = \
        [{'owner': 'eunice@gmail.com', 'name': 'Rave'}, \
        {'owner': 'eunice@gmail.com', 'name': 'Adventure'}, \
        {'owner': 'eunice@gmail.com', 'name': 'Shagz'}]
        msg = self.recipes.create_recipe(
            'Rave', "eunice@gmail.com")
        self.assertEqual(msg, \
        [{'owner': 'eunice@gmail.com', 'name': 'Beef'}, \
        {'owner': 'eunice@gmail.com', 'name': 'Pilau Njeri'}])
