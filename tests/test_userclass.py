...
class AccountTestCases(unittest.TestCase):
    ...
    def test_case_existing_user(self):
        ...
        msg = self.user.registeruser(
            "eunice", "gatehieunice@gmail.com", "eunicegatehi", "eunicegatehi")
    ...
    def test_case_short_pwd(self):
        ...
        """
        msg = self.user.registeruser(
            "Eunice", "gatehieunice@gmail.com", "eunice", "eunice")
        self.assertEqual(
    ...
    def test_case_special_char(self):
        ...
        """
        msg = self.user.registeruser(
            "Eunice gatehi", "gatehieunice@gmail.com", "eunicegatehi", "eunicegatehi")
        self.assertIn(msg, "No special characters ")
    ...
    def test_case_login_noaccount(self):
        ...
        msg = self.user.login("wanjigi@gmail.com", "eunicegatehi")
    ...
    def test_case_correct_login(self):
        ...
        self.assertIn("create recipe!", msg)
